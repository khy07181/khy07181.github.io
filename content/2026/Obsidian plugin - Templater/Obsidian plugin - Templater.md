...
Templater는 `2026-09-14` 안에서 값을 계산한다.

| 구분     | 기본 Templates           | Templater                      |
| ------ | ---------------------- | ------------------------------ |
| 문법     | `{{date}}`, `{{time}}` | `quartz-blog-version-up`          |
...
Templater 문법은 `2026-07-06T00:17` 형태를 사용한다.
...
```md
last cursor point : 2026-07-06T00:17
```
...
| `2026-09-14` | 파일 제목 넣기 |
| `2026-09-13` | 생성 시간 넣기 |
| `<% tp.file.cursor() %>` | 오늘 날짜 넣기 |
| `undefined` | 하루 전 날짜 넣기 |
| `undefined` | 입력 시작 위치 정하기 |
